...
\begin{document}
    ...
    Uporabljali bomo program napisan v C++ ter knjižnice za izrisovanje imenovano OpenGL.
...
% ─────────────────────────────────────────────────────────────────────────
    ...
    Pri \emph{ray tracingu} pa to delamo v obratni smeri:
...
u_ObjScale= 0.200
    ...
    Čeprav je izrisovan ekran bil velik $1024 \times 1024 = 1'048'576$, to pomeni več kot 1 miljon žarkov na sliko je GPU (v našem primeru NVIDIA GeForce RTX 3060 Ti) sliko v povprečju generiral le v 6 milisekundah!
    Kar nam pove kako učinkovito je vzporedno procesiranje za takšne naloge.
