...
for (int i = 0; i < 2; i++) {
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|l|l|}
            ...
            \hline
            \texttt{u\_r}        & Polmer sferne leče              & $0.1 \ldots 3.0$ \\
            \texttt{u\_n}        & Lomni količnik stekla           & $1.5$ \\
            ...
            \texttt{u\_ObjScale} & Velikost objekta na zaslobu     & $0.5 \ldots 2.0$ \\
            \hline
        \end{tabular}
...
u_ObjScale= 0.200
    ...
    Čeprav je izrisovan ekran bil velik $1024 * 1024 = 1'048'576$, to pomeni več kot 1 miljon žarkov na sliko je GPU (v našem primeru NVIDIA GeForce RTX 3060 Ti) sliko v povprečju generiral le v 6 milisekundah!
